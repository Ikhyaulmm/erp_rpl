...
<head>
    ...
    <title>ERP RPL UAD | Warehouse List</title>
    <!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="title" content="AdminLTE v4 | Warehouse List" />
                        ...
                        <div class="col-md-12">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h3 class="card-title">Warehouse Data</h3>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            @forelse ($warehouses as $warehouse)
                                                <tr class="align-middle">
                                                    ...
                                                    <td>
                                                        <span class="badge bg-{{ $warehouse->is_rm_warehouse ? 'success' : 'secondary' }}">
                                                            {{ $warehouse->is_rm_warehouse ? 'Yes' : 'No' }}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-{{ $warehouse->is_fg_warehouse ? 'success' : 'secondary' }}">
                                                            {{ $warehouse->is_fg_warehouse ? 'Yes' : 'No' }}
                                                        </span>
                                                    </td>
                                                    <td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="9" class="text-center">No warehouses found</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
